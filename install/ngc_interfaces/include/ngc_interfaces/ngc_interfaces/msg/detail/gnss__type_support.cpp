...
{
  new (message_memory) ngc_interfaces::msg::GNSS(_init);
}

void GNSS_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ngc_interfaces::msg::GNSS *>(message_memory);
  typed_message->~GNSS();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GNSS_message_member_array[3] = {
  {
    ...
    offsetof(ngc_interfaces::msg::GNSS, lat),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ngc_interfaces::msg::GNSS, lon),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ngc_interfaces::msg::GNSS, valid_signal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GNSS_message_members = {
  ...
  "GNSS",  // message name
  3,  // number of fields
  sizeof(ngc_interfaces::msg::GNSS),
...
{
  return &::ngc_interfaces::msg::rosidl_typesupport_introspection_cpp::GNSS_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ngc_interfaces, msg, GNSS)() {
  return &::ngc_interfaces::msg::rosidl_typesupport_introspection_cpp::GNSS_message_type_support_handle;
}
